...
def main():
    ...
    # # Dropout with Epochs=100, Epochs=512
    # parser = MLT.run.create_parser()
    ...
    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--unsupervised', '-k', '10', '--nsl16', '--AutoEncoder', '512', '100', '0.8', '0.001', '--mail'])
    # MLT.run.main(args)

    # # Learning Rate  with Epochs=100, Epochs=512, Dropout=0.2
    parser = MLT.run.create_parser()
