...
def main():
    ...
    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['-k', '10', '--splunkr', '--XGBoost', '150', '10', '0.1'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['-k', '10', '--splunkr', '--XGBoost', '150', '10', '0.01'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['-k', '10', '--splunkr', '--XGBoost', '150', '10', '0.001'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['-k', '10', '--splunkr', '--XGBoost', '150', '10', '0.0001'])
    # MLT.run.main(args)
