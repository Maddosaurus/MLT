...
def main():
    ...
    # max_features
    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.1', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.2', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.3', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.4', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.5', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.6', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.7', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.8', 'True'])
    # MLT.run.main(args)

    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '0.9', 'True'])
    # MLT.run.main(args)
    ...
    # Bootstrap
    # parser = MLT.run.create_parser()
    # args = parser.parse_args(['--anomaly', '--unsupervised', '-k', '10', '--splunkr', '--IsolationForest', '400', '1.0', 'False', '--mail'])
    # MLT.run.main(args)
